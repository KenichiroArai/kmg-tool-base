...
classDiagram
    ...
    AbstractDynamicTemplateConversionTool <|-- AccessorCreationlTool
    ...
    %% ロジック関係
    AccessorCreationlTool --> AccessorCreationService : uses
    ...
    %% テンプレート関連
    AccessorCreationlTool ..> AccessorCreationlTool.yml : uses template
    ...
    class AccessorCreationlTool.yml {
        csvPlaceholders
        derivedPlaceholders
        templateContent
    }
...
AccessorCreationlTool.ymlは以下の構造を持っています：
