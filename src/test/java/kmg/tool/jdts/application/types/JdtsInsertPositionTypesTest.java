...
public class JdtsInsertPositionTypesTest extends AbstractKmgTest {
    ...
    public void testConstructor_normalAllEnumValuesCorrectlySet() {
        ...
        /* 期待値の定義 */
        final JdtsInsertPositionTypes[] expectedValues = {
            JdtsInsertPositionTypes.NONE, JdtsInsertPositionTypes.BEGINNING, JdtsInsertPositionTypes.END,
            JdtsInsertPositionTypes.PRESERVE
        };

        /* 準備 */

        /* テスト対象の実行 */
        final JdtsInsertPositionTypes[] testResult = JdtsInsertPositionTypes.values();

        /* 検証の準備 */
        final JdtsInsertPositionTypes[] actualResult = testResult;
    ...
    public void testGet_normalAllEnumGetsCorrect() {
        ...
        /* 準備 */
        final JdtsInsertPositionTypes[] testTargets = JdtsInsertPositionTypes.values();
    ...
    public void testGet_normalKeyReturned() {
        ...
        /* 期待値の定義 */
        final String expectedResult = "beginning";

        /* 準備 */
        final JdtsInsertPositionTypes testTarget = JdtsInsertPositionTypes.BEGINNING;
    ...
    public void testGetDefault_normalDefaultValueReturned() {
        ...
        /* 期待値の定義 */
        final JdtsInsertPositionTypes expectedResult = JdtsInsertPositionTypes.NONE;

        /* 準備 */

        /* テスト対象の実行 */
        final JdtsInsertPositionTypes testResult = JdtsInsertPositionTypes.getDefault();
    ...
    public void testGetDetail_normalAllEnumDetailsCorrect() {
        ...
        final String[] expectedDetails = {
            "指定無し", // NONE
            "Javadocタグの先頭に挿入", // BEGINNING
            "Javadocタグの末尾に挿入", // END
            "既存のJavadocタグが存在する場合は現在の位置を維持" // PRESERVE
        };
    ...
    public void testGetDetail_normalDetailReturned() {
        ...
        /* 期待値の定義 */
        final String expectedResult = "Javadocタグの先頭に挿入";
    ...
    public void testGetDisplayName_normalDisplayNameReturned() {
        ...
        /* 期待値の定義 */
        final String expectedResult = "Javadocタグの先頭";
    ...
    public void testGetEnum_normalExistingKeySpecified() {
        ...
        /* 期待値の定義 */
        final JdtsInsertPositionTypes expectedResult = JdtsInsertPositionTypes.BEGINNING;

        /* 準備 */
        final String testKey = "beginning";

        /* テスト対象の実行 */
        final JdtsInsertPositionTypes testResult = JdtsInsertPositionTypes.getEnum(testKey);
    ...
    public void testGetInitValue_normalInitValueReturned() {
        ...
        /* テスト対象の実行 */
        final JdtsInsertPositionTypes testResult = JdtsInsertPositionTypes.getInitValue();
    ...
    public void testValuesMap_normalAllEnumValuesInMap() {
        ...
        /* テスト対象の実行 */
        final JdtsInsertPositionTypes testResult = JdtsInsertPositionTypes.getEnum("beginning");
        ...
        Assertions.assertEquals(JdtsInsertPositionTypes.BEGINNING, actualResult, "マップから正しい列挙型が取得されること");
