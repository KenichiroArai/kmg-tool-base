...
public class JdtsLocationConfigModelImplTest extends AbstractKmgTest {
    ...
    public void testConstructor_normalCompliantMode() throws Exception {
        ...
        final boolean expectedRemoveIfMisplaced = true;
        ...
        testLocationMap.put(JdtsConfigKeyTypes.TARGET_ELEMENTS.get(), new ArrayList<String>());
        ...
        Assertions.assertEquals(expectedRemoveIfMisplaced, this.testTarget.isRemoveIfMisplaced(), "誤配置時の削除設定が正しく設定されること");
        Assertions.assertEquals(expectedTargetElementsSize, this.testTarget.getTargetElements().size(), "対象要素リストが空であること");
    ...
    public void testConstructor_normalManualMode() throws Exception {
        ...
        final boolean expectedRemoveIfMisplaced = false;
        ...
        Assertions.assertEquals(expectedMode, this.testTarget.getMode(), "配置方法が正しく設定されること");
        Assertions.assertEquals(expectedRemoveIfMisplaced, this.testTarget.isRemoveIfMisplaced(), "誤配置時の削除設定が正しく設定されること");
        Assertions.assertEquals(expectedTargetElementsSize, this.testTarget.getTargetElements().size(), "対象要素リストのサイズが正しいこと");
        Assertions.assertTrue(this.testTarget.getTargetElements().contains(JavaClassificationTypes.CLASS), "CLASS要素が含まれていること");
        Assertions.assertTrue(this.testTarget.getTargetElements().contains(JavaClassificationTypes.METHOD), "METHOD要素が含まれていること");
    ...
    public void testIsRemoveIfMisplaced_normalReturnRemoveIfMisplaced() throws Exception {
        ...
        /* 検証の実施 */
        Assertions.assertEquals(expectedRemoveIfMisplaced, testResult, "誤配置時の削除設定が正しく返されること");
