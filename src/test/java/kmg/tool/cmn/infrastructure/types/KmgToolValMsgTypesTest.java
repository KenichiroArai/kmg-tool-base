...
public class KmgToolValMsgTypesTest {
    ...
    public void testGetDefault_normalDefaultValue() {
        ...
        /* テスト対象の実行 */
        final KmgToolValMsgTypes actual = KmgToolValMsgTypes.getDefault();
    ...
    public void testGetEnum_normalExistingValue() {
        ...
        /* 期待値の定義 */
        final KmgToolValMsgTypes expected = KmgToolValMsgTypes.KMGTOOL_VAL13000;

        /* 準備 */
        final String testValue = "KMGTOOL_VAL13000";
    ...
    public void testGetInitValue_normalInitialValue() {
        ...
        /* テスト対象の実行 */
        final KmgToolValMsgTypes actual = KmgToolValMsgTypes.getInitValue();
