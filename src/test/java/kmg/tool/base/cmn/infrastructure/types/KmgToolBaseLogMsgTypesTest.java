...
public class KmgToolBaseLogMsgTypesTest {
     ...
     * @since 0.2.4
     */
    public KmgToolBaseLogMsgTypesTest() {
    ...
    public void testGet_normalBasicValue() {
        ...
        /* 期待値の定義 */
        final String expected = "KMGTOOLBASE_LOG01000";

        /* 準備 */
        final KmgToolBaseLogMsgTypes testType = KmgToolBaseLogMsgTypes.KMGTOOLBASE_LOG01000;
    ...
    public void testGet_normalNoneValue() {
        ...
        /* 準備 */
        final KmgToolBaseLogMsgTypes testType = KmgToolBaseLogMsgTypes.NONE;
    ...
    public void testGetDefault_normalDefaultValue() {
        ...
        /* 期待値の定義 */
        final KmgToolBaseLogMsgTypes expected = KmgToolBaseLogMsgTypes.NONE;

        /* テスト対象の実行 */
        final KmgToolBaseLogMsgTypes actual = KmgToolBaseLogMsgTypes.getDefault();
    ...
    public void testGetEnum_normalAnotherExistingValue() {
        ...
        /* 期待値の定義 */
        final KmgToolBaseLogMsgTypes expected = KmgToolBaseLogMsgTypes.KMGTOOLBASE_LOG01001;

        /* 準備 */
        final String testValue = "KMGTOOLBASE_LOG01001";

        /* テスト対象の実行 */
        final KmgToolBaseLogMsgTypes actual = KmgToolBaseLogMsgTypes.getEnum(testValue);
    ...
    public void testGetEnum_normalExistingValue() {
        ...
        /* 期待値の定義 */
        final KmgToolBaseLogMsgTypes expected = KmgToolBaseLogMsgTypes.KMGTOOLBASE_LOG01000;

        /* 準備 */
        final String testValue = "KMGTOOLBASE_LOG01000";
    ...
    public void testGetInitValue_normalInitialValue() {
        ...
        /* テスト対象の実行 */
        final KmgToolBaseLogMsgTypes actual = KmgToolBaseLogMsgTypes.getInitValue();
    ...
    /**
     * toString メソッドのテスト - 正常系:KMGTOOLBASE_LOG01000の文字列表現
     *
     * @since 0.2.4
     */
    @Test
    public void testToString_normalKmgtoolLog01000() {
        ...
        /* 検証の実施 */
        Assertions.assertEquals(expected, actual, "KMGTOOLBASE_LOG01000の場合、'KMGTOOLBASE_LOG01000'が返されること");
