...
public class IsCreationToolTest extends ApplicationTest {
    ...
    public void testStart_normalCompleteCoverage() throws Exception {
        ...
        Mockito
            .when(this.mockSpringContext.getBean(
                ArgumentMatchers.eq(kmg.tool.base.is.presentation.ui.gui.controller.IsCreationController.class)))
            .thenReturn(Mockito.mock(kmg.tool.base.is.presentation.ui.gui.controller.IsCreationController.class));
